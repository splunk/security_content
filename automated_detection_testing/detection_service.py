...
def main(args):
    ...
    module.sys.argv = ['attack_range', '--config', 'attack_range/attack_range.conf', '--action', 'test', '--test_file', 'security-content/tests/' + test_file_name + '.yml']
    ...
    try:
        ...
        print('Error: ' + str(e))
        module.sys.argv = ['attack_range', '--config', 'attack_range/attack_range.conf', '--action', 'destroy']
