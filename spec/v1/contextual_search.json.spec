{
    ...
    "title": "Contextual Search Manifest",
    "description": "The fields that make up the manifest of a version 1 contextual search",
    "type": "object",
    "properties": {
        "channel": {
        ...
        "spec_version": {
            "description": "The version of the contextual search specification this manifest follows",
            "type": "integer"
        },
        "status": {
