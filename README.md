...
* [security_content_automation/](security_content_automation/): It contains scripts for enriching detection with relevant supported TAs and for publishing github release assets to Pre-QA on every tag release.
