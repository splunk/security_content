...
excerpt: "Get the latest **FREE** Enterprise Security Content Update (ESCU) App with **714** detections for Splunk."
feature_row:
  - image_path: /static/feature_detection.png
    alt: "customizable"
    title: "Detections"
    excerpt: "See all **714** Splunk Analytics built to find evil 😈."
    url: "/detections"
