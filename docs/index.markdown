...
excerpt: "Get the latest **FREE** Enterprise Security Content Update (ESCU) App with **660** detections for Splunk."
feature_row:
  - image_path: /static/feature_detection.png
    alt: "customizable"
    title: "Detections"
    excerpt: "See all **660** Splunk Analytics built to find evil 😈."
    url: "/detections"
  ...
  - image_path: /static/feature_stories.png
    ...
    excerpt: "See all **104** use cases, 📦 of detections built to address a threat."
    url: "/stories"
    btn_class: "btn--primary"
    btn_label: "Explore"
