...
excerpt: "Get the latest **FREE** Enterprise Security Content Update (ESCU) App with **684** detections for Splunk."
feature_row:
  - image_path: /static/feature_detection.png
    alt: "customizable"
    title: "Detections"
    excerpt: "See all **684** Splunk Analytics built to find evil 😈."
    url: "/detections"
