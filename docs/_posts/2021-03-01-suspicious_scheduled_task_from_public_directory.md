...
** Note that `suspicious_scheduled_task_from_public_directory_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
