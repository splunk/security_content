...
** Note that `domain_controller_discovery_with_wmic_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/domain_controller_discovery_with_wmic.yml) \| *version*: **1**