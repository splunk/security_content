...
** Note that `suspicious_wav_file_in_appdata_folder_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
