...
**Note that `suspicious_plistbuddy_usage_via_osquery_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.**
