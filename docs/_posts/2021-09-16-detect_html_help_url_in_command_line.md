...
**Note that `detect_html_help_url_in_command_line_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.**
