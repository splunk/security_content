...
** Note that `linux_install_kernel_module_using_modprobe_utility_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
