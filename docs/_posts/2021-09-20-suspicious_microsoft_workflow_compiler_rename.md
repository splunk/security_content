...
**Note that `suspicious_microsoft_workflow_compiler_rename_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.**
