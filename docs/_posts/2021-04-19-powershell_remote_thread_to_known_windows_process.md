...
** Note that `powershell_remote_thread_to_known_windows_process_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
