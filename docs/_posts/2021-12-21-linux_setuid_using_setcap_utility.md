...
**Note that `linux_setuid_using_setcap_utility_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.**
