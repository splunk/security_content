...
** Note that `high_frequency_copy_of_files_in_network_share_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
