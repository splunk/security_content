...
**Note that `detect_software_download_to_network_device_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.**
