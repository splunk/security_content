...
** Note that `o365_add_app_role_assignment_grant_user_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
