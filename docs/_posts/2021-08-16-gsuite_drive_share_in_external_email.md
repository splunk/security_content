...
**Note that `gsuite_drive_share_in_external_email_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.**
