...
** Note that `detect_aws_console_login_by_user_from_new_country_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
