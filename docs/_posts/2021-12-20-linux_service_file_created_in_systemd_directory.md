...
** Note that `linux_service_file_created_in_systemd_directory_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
