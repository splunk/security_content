...
** Note that `detect_wmi_event_subscription_persistence_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
