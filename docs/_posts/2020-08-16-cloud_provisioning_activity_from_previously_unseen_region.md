...
**Note that `cloud_provisioning_activity_from_previously_unseen_region_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.**
