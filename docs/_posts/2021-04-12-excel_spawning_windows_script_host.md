...
** Note that `excel_spawning_windows_script_host_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
