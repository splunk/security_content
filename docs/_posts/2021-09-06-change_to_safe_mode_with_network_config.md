...
** Note that `change_to_safe_mode_with_network_config_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
