...
** Note that `7zip_commandline_to_smb_share_path_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
