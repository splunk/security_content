...
**Note that `auto_admin_logon_registry_entry_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.**
