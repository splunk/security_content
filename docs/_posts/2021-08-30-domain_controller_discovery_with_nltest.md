...
**Note that `domain_controller_discovery_with_nltest_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.**
