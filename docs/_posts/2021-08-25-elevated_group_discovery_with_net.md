...
** Note that `elevated_group_discovery_with_net_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
