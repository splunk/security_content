...
**Note that `detection_of_tools_built_by_nirsoft_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.**
