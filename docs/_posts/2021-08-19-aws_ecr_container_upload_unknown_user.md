...
** Note that `aws_ecr_container_upload_unknown_user_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
