...
** Note that `recursive_delete_of_directory_in_batch_cmd_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
