...
** Note that `execute_javascript_with_jscript_com_clsid_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
