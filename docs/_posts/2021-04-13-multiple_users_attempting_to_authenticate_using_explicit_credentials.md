...
**Note that `multiple_users_attempting_to_authenticate_using_explicit_credentials_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.**
