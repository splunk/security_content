...
** Note that `linux_file_creation_in_profile_directory_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
