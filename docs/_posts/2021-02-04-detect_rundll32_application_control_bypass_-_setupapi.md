...
** Note that `detect_rundll32_application_control_bypass_-_setupapi_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
