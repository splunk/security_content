...
**Note that `detect_attackers_scanning_for_vulnerable_jboss_servers_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.**
