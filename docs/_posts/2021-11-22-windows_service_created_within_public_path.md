...
**Note that `windows_service_created_within_public_path_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.**
