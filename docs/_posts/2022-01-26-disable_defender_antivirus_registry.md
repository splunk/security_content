...
** Note that `disable_defender_antivirus_registry_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
