...
** Note that `linux_service_started_or_enabled_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
