...
** Note that `wermgr_process_create_executable_file_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
