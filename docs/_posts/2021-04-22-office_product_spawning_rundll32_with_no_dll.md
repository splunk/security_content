...
** Note that `office_product_spawning_rundll32_with_no_dll_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
