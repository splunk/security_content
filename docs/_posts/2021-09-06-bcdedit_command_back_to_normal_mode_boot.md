...
**Note that `bcdedit_command_back_to_normal_mode_boot_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.**
