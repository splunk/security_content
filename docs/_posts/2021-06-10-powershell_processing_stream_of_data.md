...
** Note that `powershell_processing_stream_of_data_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
