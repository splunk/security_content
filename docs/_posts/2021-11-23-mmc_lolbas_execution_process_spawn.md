...
** Note that `mmc_lolbas_execution_process_spawn_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
