...
** Note that `enumerate_users_local_group_using_telegram_filter` is a empty macro by default. It allows any user to filter out any results (false positives) without editing the SPL.
