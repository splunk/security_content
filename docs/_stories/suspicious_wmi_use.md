...
| [Windows WMI Process Call Create](/endpoint/windows_wmi_process_call_create/) | None| Hunting |
| [WMI Permanent Event Subscription - Sysmon](/endpoint/wmi_permanent_event_subscription_-_sysmon/) | None| TTP |
| [WMIC XSL Execution via URL](/endpoint/wmic_xsl_execution_via_url/) | None| TTP |
