...
class TestDriver:
    ...
    def addError(self, result:dict, duration_string:str)->None:
        ...
        for required_field in ['search_string', 'diskUsage','runDuration', 'detection_name', 'scanCount','eventCount', 'detection_error', 'detection_file']:
    ...
    def outputResultsFiles(self, baseline:OrderedDict, fields:list[str]=['detection_name', 'detection_file','runDuration','diskUsage', 'search_string', 'error', 'success', 'scanCount', 'eventCount', 'detection_error'])->bool:
